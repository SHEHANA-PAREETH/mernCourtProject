...
<a href="#" className="hero-image-container">
 <img src={`${process.env.REACT_APP_BASE_URL}/uploads/${cancelledData.courts.image[0].filename}`} alt="" />
</a>
<main class="main-content">
  <h3><a href="#">{cancelledData.courts.name}</a></h3>
